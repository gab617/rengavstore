  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-5 left-5 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl shadow-green-500/30 ring-4 ring-white/60 transition-all hover:bg-[#1fb857] hover:shadow-2xl active:scale-95"
      >
        {open ? (
          <svg
            className="h-5 w-5"
